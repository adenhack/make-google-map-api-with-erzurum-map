...
xmlhttp.open("GET", "./ilceler_xml/Karaçoban_Mahalle.xml", false);
xmlhttp.send();
xmlDoc = xmlhttp.responseXML;

var x = xmlDoc.getElementsByTagName("Karaçoban_Mahalle");
...
for (i = 0; i < x.length; i++) {
    ...
    mahalleler.innerHTML += `
        ...
        <option value="${titleName}" id="orta" data-chained="karacoban"> 
