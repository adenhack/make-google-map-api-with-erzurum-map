...
xmlhttp.open("GET", "./ilceler_xml/Senkaya_Mahalle.xml", false);
xmlhttp.send();
xmlDoc = xmlhttp.responseXML;

var x = xmlDoc.getElementsByTagName("Şenkaya_Mahalle");
...
for (i = 0; i < x.length; i++) {
    ...
    mahalleler.innerHTML += `
        ...
        <option value="${titleName}" id="orta" data-chained="senkaya"> 
