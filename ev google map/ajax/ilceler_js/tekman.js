...
xmlhttp.open("GET", "./ilceler_xml/Tekman_Mahalle.xml", false);
xmlhttp.send();
xmlDoc = xmlhttp.responseXML;

var x = xmlDoc.getElementsByTagName("Tekman_Mahalle");
...
for (i = 0; i < x.length; i++) {
    ...
    mahalleler.innerHTML += `
        ...
        <option value="${titleName}" id="orta" data-chained="tekman"> 
